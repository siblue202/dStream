...
case class HashAggregateExec(
  ...
  override lazy val metrics = Map(
    ...
    "aggTime" -> SQLMetrics.createNanoTimingMetric(sparkContext, "time in aggregation build"),
    "avgHashProbe" ->
...
//      aggTime += NANOSECONDS.toMillis(System.nanoTime() - beforeAgg) // jgh
      aggTime += System.nanoTime() - beforeAgg // jgh
      res
    }
  }
