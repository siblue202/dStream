 ...
 *   version of the data can be accessed. It is the responsible of the provider to
...
object StateStore extends Logging {
  ...
  private def getStateStoreProvider(
    ...
    loadedProviders.synchronized {
      // jgh
//      val startTime = System.currentTimeMillis() // jgh
...
//      println(s"getStateStoreProvider's duration: ${duration} on getStateStoreProvider() " +
//        s"in StateStore")
